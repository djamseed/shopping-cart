namespace ShoppingCart.Infrastructure.ReadModel.Cart.EventHandlers
{
    ...
    public sealed class ItemRemovedHandler : IEventHandlerAsync<ItemRemoved>
    {
        private readonly IRepository<CartReadModel> repository;

        public ItemRemovedHandler(IRepository<CartReadModel> repository)
        {
            this.repository = repository;
        }

        public async Task HandleAsync(ItemRemoved @event)
        {
